...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="bookinfo.php">Show Book</a>
                    </li>
                    <!-- Dropdown -->
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="pinjam/datapinjam.php">Booking</a></li>
    ...
    <h1 class="container mt-4">List Book</h1>
    <div class="row">
        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
            <div class="card">
                <div class="card-body container">
                    <p>List buku yang tersedia</p>
                        ...
                        <table class="table container">
                            ...
                            if ($res->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="../book/pinjam/pinjambuku.php?id=<?php echo $row["id_buku"];?>" class="btn btn-sm btn-outline-primary">Pinjam</a>                                        
                                    </td>
                                </tr>
                                <?php
                                $no++;    
